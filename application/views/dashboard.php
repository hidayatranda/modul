	...
	<div class="row">
		...
		<div class="row">
			<div class="col-lg-4 mb-4">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						...
						<h6 class="m-0 font-weight-bold text-primary">Python</h6>
					</div>
					<div class="card-body">
			...
			<div class="col-lg-4 mb-4">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Java Script</h6>
					</div>
					<div class="card-body">
						<div class="text-center">
							<img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
		...
		<div class="row">
			<div class="col-lg-4 mb-4">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Kotlin</h6>
					</div>
					<div class="card-body">
						<div class="text-center">
							<img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
			...
			<div class="col-lg-4 mb-4">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Java</h6>
					</div>
					<div class="card-body">
						<div class="text-center">
							<img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
			...
			<div class="col-lg-4 mb-4">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Angular</h6>
					</div>
					<div class="card-body">
						<div class="text-center">
							<img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
...
<!-- Footer -->
<footer class="sticky-footer bg-white" sty>
